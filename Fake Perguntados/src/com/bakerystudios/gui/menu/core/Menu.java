...
public abstract class Menu extends InputListener implements Renderable, Updateble {
	...
	public static void setUp(boolean up) {Menu.up = up;}
	public static boolean isDown() {return down;}
	public static void setDown(boolean down) {Menu.down = down;}
	public static boolean isEnter() {return enter;}
	public static void setEnter(boolean enter) {Menu.enter = enter;}
